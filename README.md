...
import { getUnknownFaces, clearUnknownFaces, deleteUnknownFace, getDepartments, registerFaculty } from '../services/api'
...
export default function UnknownFaces() {
  ...
  const handleDelete = async (log) => {
    try {
      await deleteUnknownFace(log.id)
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: '13px', fontWeight: 500, color: '#F64F3B' }}>
            What are unknown alerts?
          </div>
        ...
        <div style={{
          ...
          {logs.map((log, i) => (
            <div key={log.id || i} style={{
              background: '#0D1421',
              border: '1px solid rgba(246,79,59,0.2)',
              ...
              <button
                ...
                style={{
                  ...
                  border: '1px solid rgba(246,79,59,0.4)',
                  borderRadius: '6px', color: '#F64F3B',
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  background: 'rgba(246,79,59,0.85)', backdropFilter: 'blur(8px)',
                  fontSize: '10px', fontWeight: 700, color: 'white', letterSpacing: '0.5px'
                }}>⚠ UNKNOWN</div>
              </div>
              ...
              <div style={{ padding: '14px 16px' }}>
                ...
                <div style={{ fontSize: '11px', color: '#5A6A85', marginBottom: '14px' }}>
                  🕐 {log.detected_at}
                </div>
                <Btn
...
function RegisterFromSnapshotModal({ log, onClose, onSuccess }) {
  ...
  const [captureMode, setCaptureMode] = useState('snapshot')
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={onClose} style={{
            ...
            color: '#5A6A85', cursor: 'pointer', fontSize: '20px', padding: '4px'
          }}>✕</button>
        </div>
          ...
          <div>
              ...
              <>
                ...
                <label htmlFor="unknown-upload">
                  <div style={{
                    ...
                    {uploadedFile ? `✅ ${uploadedFile.name}` : '📁 Browse Photo'}
                  </div>
                </label>
              </>
            )}
            ...
            {captureMode === 'snapshot' && (
              <div style={{
                ...
                background: log.snapshot ? 'rgba(0,229,195,0.06)' : 'rgba(246,79,59,0.06)',
                border: `1px solid ${log.snapshot ? 'rgba(0,229,195,0.15)' : 'rgba(246,79,59,0.15)'}`,
                fontSize: '11px',
                color: log.snapshot ? '#00E5C3' : '#F64F3B'
              }}>
                {log.snapshot ? '✅ Using detected snapshot' : '⚠ No snapshot available'}
              </div>
            )}
          </div>
        </div>
